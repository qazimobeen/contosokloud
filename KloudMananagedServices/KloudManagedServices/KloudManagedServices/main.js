...
$(document).ready(function () {
    window.authConfig = {
        tenant: 'kloud1',
        clientId: '6ff39a79-f0f4-4668-ab29-44887dc250c2',
        redirectUri: 'https://contosomanagedservices.azurewebsites.net/index.html',
        postLogoutRedirectUri: 'https://contosomanagedservices.azurewebsites.net/logout.html',
        endpoints: {
    ...
    window.appConfig = {
        siteUrl: '/sites/contosomanagedservices',
