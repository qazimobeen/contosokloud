...
{
    [Serializable]
    public class MachineStopInquireDialog : IDialog<string>
    {
        ...
        public async Task StartAsync(IDialogContext context)
        {
            ...
            PromptDialog.Choice(context, this.OnOptionsSelected, vmList, "What machine do you want to stop?  Below is a list of possible VMs.", "I'm sorry, I don't understand your reply. Please choose from the list or with the name of a VM.", 3);
